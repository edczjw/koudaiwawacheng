...
module.exports = {
	...
	requestInit : function(sets, withLoginToken){
		...
		if(withLoginToken){
			var loginToken = this.checkLogin(true);
	...
	checkLogin : function (notLoginDo) {
		var loginToken = "eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjMwMDI0ODY4fQ.SKC9oZRKwhAUzv248V41u-AqPw7OrpRWZE-ytSg3tQY";
	...
	gotoLogin : function (path, opentype) {
		if(!path){path = '/pages/public/login';}
