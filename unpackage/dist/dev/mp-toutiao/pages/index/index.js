...
/***/ 326:
/*!*********************************************************************************!*\
  !*** /Users/cengjunwei/Desktop/uniwwj/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \*********************************************************************************/
...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/index/index.vue */ 327));
// @ts-ignore
...
/***/ 327:
/*!**************************************************************!*\
  !*** /Users/cengjunwei/Desktop/uniwwj/pages/index/index.vue ***!
  \**************************************************************/
/*! no static exports found */
...
/***/ 328:
/*!*********************************************************************************************!*\
  !*** /Users/cengjunwei/Desktop/uniwwj/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \*********************************************************************************************/
...
/***/ 329:
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--17-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/cengjunwei/Desktop/uniwwj/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 330:
/*!***************************************************************************************!*\
  !*** /Users/cengjunwei/Desktop/uniwwj/pages/index/index.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 331:
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/cengjunwei/Desktop/uniwwj/pages/index/index.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _utils = _interopRequireDefault(__webpack_require__(/*! @/common/utils.js */ 37));
...
var _default = {
  ...
  methods: _objectSpread(_objectSpread({}, (0, _vuex.mapMutations)(['setCurrentMachine'])), {}, {
    ...
    open: function open() {
      uni.$emit('dollMachineList', {
        selectDollName: this.selectDollName,
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                // uni.showLoading();
                uni.http.get('doll/list').then(function (res) {
                  var dollList = res.data.dollList;
                  _this2.dollList = dollList || [];
                  _this2.categoriesTabs = res.data.categories;
                  _this2.categoriesTabs.splice(0, 0, {
                    id: 0,
                    name: '全部'
                  });
    ...
    initBanner: function initBanner(type) {
      var _this3 = this;
        ...
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                uni.http.get('banner?dataVersion=0').then(function (res) {
                  if (res.code == 200) {
    ...
    navToMachinePage: function navToMachinePage(item) {
      ...
      var id = item.id;
      var machineIds = item.machineIds;
      if (!machineIds || machineIds.length == 0) {
        ...
        // uni.showLoading();
        uni.http.get('machine/list/' + item.id).then(function (res) {
          _this4.machineList = res.data.machineList || [];
        });
    ...
    bannerTab: function bannerTab(item) {
      if (item.jumpType == 'outLink') {} else if (item.jumpType == 'innerPage') {
    ...
    getDollsByCategorieId: function getDollsByCategorieId(id) {
      var dolls = this.dollList;
      if (id == 0) {
        dolls = this.dollList;
      } else {
        dolls = this.dollList.filter(function (item) {
    ...
    onswiperscroll: function onswiperscroll() {},
    ...
    setInterval: function (_setInterval) {
      ...
      this.timer = setInterval(function () {
        i++;
        if (_this6.dollList.length == 0 && _this6.carouselList.length == 0) {
          _this6.initBanner('init');
          _this6.getdata();
        } else {
    ...
    lottery: function lottery() {
      var _this7 = this;
      if (this.user) {
        uni.http.get('user/checkLottery?catchRecordId=' + this.cid).then(function (res) {
          if (res.code == 200) {
            _this7.rewardNames = res.rewardNames;
            _this7.rewardBGColors = res.rewardBGColors;
            _this7.$refs.lotteryPop.open();
          }
        });
      }
    },
    closeLotteryPop: function closeLotteryPop() {
      this.$refs.lotteryPop.close();
    },
    startLottery: function startLottery() {
      var _this8 = this;
      uni.http.get('user/startLottery?catchRecordId=' + this.cid).then(function (res) {
        if (res.code == 200) {
          if (_this8.luckyStatus != 0) {
            return;
          }
          _this8.luckyStatus = 1;
          // 抽奖流程
          // 检查抽奖次数，看用户是否还可以继续抽奖
          ...
          setTimeout(function () {
            // 假设中奖 index 为 2
            _this8.$refs.guiturntable.goto(res.result);
          }, 500);
    ...
    endLottery: function endLottery(index) {
...
/***/ 332:
/*!************************************************************************************************!*\
  !*** /Users/cengjunwei/Desktop/uniwwj/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 333:
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/cengjunwei/Desktop/uniwwj/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
