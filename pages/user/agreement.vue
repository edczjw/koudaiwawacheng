<template>
	<view>
		...
		<view class="gui-margin gui-margin-top">
			<text class="gui-color-gray gui-text-small-ml" style="font-size: 28rpx;">
				【口袋娃娃城】是由佛山市爪爪乐信息科技有限公司开发运营的（以下简称“我们”），我们深知个人信息对您的重要性，并会尽全力保护您的个人信息安全可靠。我们致力于维持您对我们的信任，恪守以下原则，保护您的个人信息：权责一致原则、目的明确原则、选择同意原则、最少够用原则、确保安全原则、主体参与原则、公开透明原则等。同时，我们承诺，我们将按业界成熟的安全标准，采取相应的安全保护措施来保护您的个人信息。
				...
				注册成为用户
				为完成创建账号，您需提供以下信息：您的手机号、电子邮箱地址、创建的用户名和密码等信息。
                ...
                您理解并同意，我们提供的服务需要您在您的设备中开启您的摄像头（应用于上传相册、发送音视频给到客服）、相册（应用于上传相册图片给到客服）、麦克风（发送音视频给到客服）、手机存储(缓存用户基本信息)的访问权限，以实现这些权限所涉及信息的收集和使用。我们会在您使用相关服务时弹窗提示您是否要开启相应权限。您可在您的设备应用管理中找到口袋娃娃城App,在其内容里逐项查看上述权限的状态，并可自行决定这些权限随时的开启或关闭。 请您注意，您开启任一权限即代表您授权我们可以收集和使用相关个人信息来为您提供对应服务，您一旦关闭任一权限即代表您取消了授权，我们将不再基于对应权限继续收集和使用相关个人信息，也无法为您提供该权限所对应的服务。但是，您关闭权限的决定不会影响此前基于您的授权所进行的信息收集及使用。
				...
				获得您明确同意后；基于法律的披露：在法律、法律程序、诉讼或政府主管部门强制性要求的情况下，我们可能会公开披露您的个人信息。
				...
				1.访问您的个人信息:您有权访问您的个人信息，法律法规规定的例外情况除外。如果您想行使数据访问权，您可以通过应用中的个人信息页面进行查看。
				2.更正您的个人信息:当您发现我们处理的关于您的个人信息有错误时，您有权要求我们做出更正。您可以通过应用的个人信息页面进行修改操作。
				...
				如果您不再使用我们的产品或服务；
				如果我们不再为您提供产品或服务。
				您可以通过应用注销账号时会发送删除个人信息请求，若我们决定响应您的删除请求，我们还将同时通知从我们获得您的个人信息的实体，要求其及时删除，除非法律法规另有规定，或这些实体获得您的独立授权。 当您从我们的服务中删除信息后，我们可能不会立即备份系统中删除相应的信息，但会在备份更新时删除这些信息。
				...
				如果您对本隐私政策有任何疑问、意见或建议，通过以下方式与我们联系：邮箱：1056811484@qq.com
			</text>
		</view>
